...
public final class E3E1 extends Blade implements BladeDimension3<E3E1> {
    public static final E3E1 ZERO = new E3E1(0);
    public static final E3E1 ONE = new E3E1(1);

    public E3E1(double value) {
        super(value, (byte) 0b101);
    }
    ...
    public String toString() {
        return StringTemplate.STR."E3E1[\{value()}";
    }
}
