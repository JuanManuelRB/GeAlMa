...
public record Multivector3(E0 e0, E1 e1, E2 e2, E3 e3, E1E2 e1e2, E2E3 e2e3, E3E1 e3e1,
                           E1E2E3 e1e2e3) implements Geometric3<Multivector3> {

    public static final Multivector3 ZERO = new Multivector3(Scalar.zero, Vector3.ZERO, Bivector3.ZERO, Trivector3.ZERO);
    public static final Multivector3 ONE = new Multivector3(Scalar.one, Vector3.ZERO, Bivector3.ZERO, Trivector3.ZERO);
    public static final VectorSpecies<Double> vectorSpecies = DoubleVector.SPECIES_512;
     ...
     */
    @Override
    public Multivector3 normalized() {
    ...
    public Multivector3 times(Multivector3 other) {
        ...
        E0 thisE1otherE1 = (E0) e1.times(other.e1());
    ...
    public DoubleVector toVector() {
        return DoubleVector.fromArray(
                ...
                new double[]{e0.value(), e1.value(), e2.value(), e3.value(), e1e2.value(), e2e3.value(), e3e1.value(), e1e2e3.value()},
                0
        );
    }
}
