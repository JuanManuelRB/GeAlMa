...
public final class E2E3 extends Blade implements BladeDimension3<E2E3> {
    public static final E2E3 ZERO = new E2E3(0);
    public static final E2E3 ONE = new E2E3(1);

    public E2E3(double value) {
        super(value, (byte) 0b110);
    }
    ...
    public String toString() {
        return StringTemplate.STR."E2E3[\{value()}}";
    }
