...
public record E1(double value) implements BladeDimension1<E1> {
    ...
    @Override
    public <E extends BladeDimension0<E>> E1 times(E scalar) {
        return times(scalar.value());
    }

    @Override
    public <E extends BladeDimension0<E>> E1 div(E scalar) {
        return div(scalar.value());
    }
