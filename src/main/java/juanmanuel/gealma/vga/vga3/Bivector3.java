...
public record Bivector3(E1E2 e1e2, E2E3 e2e3, E3E1 e3e1) implements Geometric3<Bivector3> {
    ...
    public Bivector3 projection(Bivector3 bivector) {
        return bivector.inverse().times(this.inner(bivector));
    }
    ...
    public Scalar outer(double other) {
        return Scalar.zero; // TODO: Implement
    }
