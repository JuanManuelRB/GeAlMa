...
public record E3(double value) implements BladeDimension3<E3> {
    ...
    @Override
    public <E extends BladeDimension0<E>> E3 times(E scalar) {
        return new E3(value() * scalar.value());
    }
    ...
    public String toString() {
        return StringTemplate.STR."E3[\{value()}]";
    }
